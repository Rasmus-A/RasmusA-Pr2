...
root.title("NotAimLabs, (Click the ball!)")
canv.pack()
...
def BallButtonAnimation():
    global blueBallText, greenBallText, goldBallText
    if blueBallPurchased == True and ballEquiped == "blue":
        blueB.config(text = "Unequip")
        blueBallText = "Unequip"
    elif blueBallPurchased == True:
        blueB.config(text = "Equip")
        blueBallText = "Equip"
    elif blueBallPurchased == False:
        blueB.config(text = "Purchase, 1000 score")
        blueBallText = "Purchase, 1000 score"

    if greenBallPurchased == True and ballEquiped == "green":
        greenB.config(text = "Unequip")
        greenBallText = "Unequip"
    elif greenBallPurchased == True:
        greenB.config(text = "Equip")
        greenBallText = "Equip"
    elif greenBallPurchased == False:
        greenB.config(text = "Purchase, 1000 score")
        greenBallText = "Purchase, 1000 score"

    if goldBallPurchased == True and ballEquiped == "gold":
        goldB.config(text = "Unequip")
        goldBallText = "Unequip"
    elif goldBallPurchased == True:
        goldB.config(text = "Equip")
        goldBallText = "Equip"
    elif goldBallPurchased == False:
        goldB.config(text = "Purchase, 2000 score")
        goldBallText = "Purchase, 2000 score"
